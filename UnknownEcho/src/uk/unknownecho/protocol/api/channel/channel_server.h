...
#ifndef UnknownKrakenUnknownEcho_CHANNEL_SERVER_H
#define UnknownKrakenUnknownEcho_CHANNEL_SERVER_H

#include <uk/unknownecho/network/api/communication/communication_type.h>
#include <uk/utils/ueum.h>

bool uk_ue_channel_server_create(char *persistent_path,
...
void uk_ue_channel_server_shutdown_signal_callback();
