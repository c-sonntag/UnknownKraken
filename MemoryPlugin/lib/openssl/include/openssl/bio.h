...
int BIO_duuk_mp_cb(int (*cb) (const void *data, size_t len, void *u),
                void *u, const char *s, int len);
int BIO_duuk_mp_indent_cb(int (*cb) (const void *data, size_t len, void *u),
                       void *u, const char *s, int len, int indent);
int BIO_dump(BIO *b, const char *bytes, int len);
int BIO_duuk_mp_indent(BIO *b, const char *bytes, int len, int indent);
# ifndef OPENSSL_NO_STDIO
int BIO_duuk_mp_fp(FILE *fp, const char *s, int len);
int BIO_duuk_mp_indent_fp(FILE *fp, const char *s, int len, int indent);
# endif
