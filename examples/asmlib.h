...
char * A_strstr (char * haystack, const char * needle);        // Search for ue_substring in string
...
size_t A_substring(char * dest, const char * source, size_t pos, size_t len); // Copy a ue_substring for source into dest
